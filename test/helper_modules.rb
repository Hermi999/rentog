...
module TestHelpers
  ...
  def load_default_test_data_to_db_before_test
    ...
    person3 = FactoryGirl.create(:person, :username => "employee_testperson1", :is_admin => 0, :locale => "en", :encrypted_password => "72bf5831e031cbcf2e226847677fccd6d8ec6fe0673549a60abb5fd05f726462", :password_salt => "zXklAGLwt7Cu", :given_name => "Kassi", :family_name => "Testperson2", :created_at => "2012-05-04 18:17:04", :is_organization => 0)
