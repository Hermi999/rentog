    ...
    describe "name getters" do
      ...
      it "returns the name of the user" do
        # Only perform this test if this isn't a organizations-only community
          ...
          expect(@test_organization.name('first_name_with_initial')).not_to be_blank
          expect(@test_organization.name('first_name_with_initial')).to eq("Bosch")
      end
      ...
      it "returns the name in desired format" do
        ...
        expect(@test_organization.name("first_name_with_initial")).to eq("Bosch")
        expect(@test_organization.name("first_name_only")).to eq("Bosch")
        expect(@test_organization.name("full_name")).to eq("Bosch")
      end
      ...
      describe "#given_name_or_username" do
        ...
        it "should return the given name if it exists" do
          ...
          expect(@test_organization.given_name_or_username).to eq("Bosch")
        end
