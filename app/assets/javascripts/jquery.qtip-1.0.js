...
(function ($) {
	...
	function positionTip(corner) {
		var self, positionAdjust, paddingCorner, paddingSize, newMargin;
		self = this;
		...
		if(corner.precedance === 'y') {
			if(corner.x === 'center') {
				...
				self.elements.tip.css({
					left: self.options.style.border.radius
				});
			}
			else {
				self.elements.tip.css({
					right: self.options.style.border.radius
				});
			}
			...
			if(corner.y === 'center') {
				...
				self.elements.tip.css({
					top: self.options.style.border.radius
				});
			}
			else {
				self.elements.tip.css({
