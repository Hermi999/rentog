...
describe Listing, type: :model do
  ...
  before(:each) do
    @listing = FactoryGirl.build(:listing, listing_shape_id: ListingShape.first)
  end
  ...
  describe "#visible_to?" do
    ...
    let(:listing) { FactoryGirl.create(:listing, community_id: community.id, listing_shape_id: ListingShape.first) }
