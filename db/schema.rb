...
ActiveRecord::Schema.define(version: 20161009170335) do
  ...
  create_table "bookings", force: :cascade do |t|
    ...
    t.string   "device_return_token", limit: 255, default: "33881b4582b5cfc17967"
  end
  ...
  create_table "custom_field_options", force: :cascade do |t|
    ...
    t.datetime "created_at",                null: false
    t.datetime "updated_at",                null: false
    t.integer  "count_listings",  limit: 4
  end
  ...
  create_table "import_listings_files", force: :cascade do |t|
    t.string   "author_id",               limit: 255
    t.string   "importfile_file_name",    limit: 255
    t.string   "importfile_content_type", limit: 255
    t.integer  "importfile_file_size",    limit: 4
    t.datetime "importfile_updated_at"
    t.datetime "created_at",                          null: false
    t.datetime "updated_at",                          null: false
  end
  ...
  create_table "invitations", force: :cascade do |t|
    ...
    t.string   "email",        limit: 255
    t.string   "target",       limit: 255,   default: "employee"
  end
  ...
  create_table "listings", force: :cascade do |t|
    ...
    t.string   "availability",                    limit: 255,   default: "intern"
  end
  ...
  create_table "people", id: false, force: :cascade do |t|
    ...
    t.boolean  "is_domain_supervisor",                             default: false
    t.boolean  "supervisor_mode_active",                           default: false
    t.string   "description_of_sales_conditions",    limit: 255
  ...
  create_table "price_comparison_devices", force: :cascade do |t|
    ...
    t.string   "seller_contact",       limit: 255
    t.string   "renting_price_period", limit: 255
  end

  create_table "price_comparison_events", force: :cascade do |t|
    t.string   "action_type", limit: 255, default: "device_chosen", null: false
    t.string   "email",       limit: 255
    t.string   "sessionId",   limit: 255,                           null: false
    t.string   "ipAddress",   limit: 255,                           null: false
    t.string   "device_name", limit: 255
    t.integer  "device_id",   limit: 4
    t.datetime "created_at",                                        null: false
    t.datetime "updated_at",                                        null: false
    t.string   "seller",      limit: 255
    t.string   "seller_link", limit: 255
    t.string   "detail_1",    limit: 255
    t.string   "detail_2",    limit: 255
    t.string   "detail_3",    limit: 255
    t.string   "detail_4",    limit: 255
    t.string   "detail_5",    limit: 255
  end
  ...
  create_table "settings", force: :cascade do |t|
    t.integer  "email_when_new_message", limit: 4,   default: 1
    t.integer  "email_when_new_comment", limit: 4,   default: 1
    t.datetime "created_at",                                     null: false
    t.datetime "updated_at",                                     null: false
    t.string   "person_id",              limit: 255
  end
  ...
  create_table "transactions", force: :cascade do |t|
    ...
    t.boolean  "deleted",                                       default: false
    t.string   "condition",                         limit: 255
    t.string   "transaction_type",                  limit: 255, default: "intern"
  end
