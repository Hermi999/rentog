        ...
        */
        ...
        var core = {
            ...
            rightPanel: function (element, leftPanel /* <- never used? */) {
                ...
                // `sn_g` (Sunday), `sa` (Saturday), or `wd` (Weekday)
                var dowClass = ["sn_g", "wd_g", "wd_g", "wd_g", "wd_g", "wd_g", "sa_g"];
                //TODO: was someone planning to allow styles to stretch to the bottom of the chart?
                //var gridDowClass = [" sn", "", "", "", "", "", " sa"];

                var yearArr = ['<div class="row_g"/>'];
                var daysInYear = 0;

                var monthArr = ['<div class="row_g"/>'];
                var daysInMonth = 0;
                ...
                switch (settings.scale) {
                    ...
                    case "hours":
                        ...
                        dataPanel.append($('<div class="row_g"/>').html(dowArr.join("")));
                        dataPanel.append($('<div class="row_g"/>').html(horArr.join("")));
                    ...
                    case "weeks":
                        ...
                        yearArr = ['<div class="row_g"/>'];
                        monthArr = ['<div class="row_g"/>'];
                        var year = range[0].getFullYear();
                        var month = range[0].getMonth();
                        var day = range[0];
                    ...
                    default:
                        ...
                        dataPanel.append($('<div class="row_g" style="margin-left: 0;" />').html(dowArr.join("")));
            ...
            markNow: function (element) {
                ...
                switch (settings.scale) {
                    case "weeks":
                        $(element).find(':findweek("' + cd + '")').removeClass('wd_g').addClass('today');
                        break;
                    case "months":
                        $(element).find(':findmonth("' + new Date().getTime() + '")').removeClass('wd_g').addClass('today');
                        break;
                    default:
        ...
        var tools = {
            ...
            getCellSize: function () {
                if (!tools._getCellSize) {
                    $("body").append(
                        $('<div style="display: none; position: absolute;" class="fn-gantt" id="measureCellWidth"><div class="row_g"></div></div>')
                    );
                    tools._getCellSize = $("#measureCellWidth .row_g").height();
            ...
            getProgressBarMargin: function () {
                if (!tools._getProgressBarMargin && tools._getProgressBarMargin !== 0) {
                    $("body").append(
                        $('<div style="display: none; position: absolute;" id="measureBarWidth" ><div class="fn-gantt"><div class="rightPanel"><div class="dataPanel"><div class="row_g day_g"><div class="bar" /></div></div></div></div></div>')
                    );
                    tools._getProgressBarMargin = parseInt($("#measureBarWidth .fn-gantt .rightPanel .day_g .bar").css("margin-left").replace("px", ""), 10);
                    tools._getProgressBarMargin += parseInt($("#measureBarWidth .fn-gantt .rightPanel .day_g .bar").css("margin-right").replace("px", ""), 10);
