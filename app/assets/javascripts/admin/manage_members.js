...
window.ST.initializeManageMembers = function() {
  ...
  var isSupervisor = createCheckboxAjaxRequest(".supervisor-members-is-supervisor", "promote_supervisor", "add_supervisor", "remove_supervisor");

  var ajaxRequest = postingAllowed.merge(isAdmin).merge(isSupervisor);
